...
\item \textbf{Product:} Assuming all dice rolls and equally likely,:
    ...
    \end{align}
    \begin{figure}[h!]
        \includegraphics[width=\columnwidth]{plots/Apoorv_PMF.png}
    ...
    \end{align}
    \begin{figure}[h!]
        \includegraphics[width=\columnwidth]{plots/Apoorv_CDF.png}
...
\item \textbf{Square:}
    ...
    \begin{align}
        ...
        \end{cases}
    \end{align}
    Thus, the probability of Peehu rolling a 36 is $p_{Z^2}(36) = \frac{1}{6}$.
    \begin{figure}[h!]
        \includegraphics[width=\columnwidth]{plots/Peehu_PMF.png}
    ...
    \end{align}
    \begin{figure}[h!]
        \includegraphics[width=\columnwidth]{plots/Peehu_CDF.png}
