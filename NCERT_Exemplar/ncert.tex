...
\begin{align}
    p_{XY}(36) &= \frac{1}{36} \sum_{i = 1}^{6} [36 \text{ mod } i = 0][\frac{36}{i} \leq 6]\\
...
\begin{align}
    ...
    &= \frac{1}{36} \sum_{j = 1}^{k} \sum_{i = 1}^{6}[j \text{ mod } i = 0][\frac{j}{i} \leq 6]
\end{align}
\begin{figure}[h!]
    \includegraphics[width=\columnwidth]{plots/CDF - Apoorv.png}
