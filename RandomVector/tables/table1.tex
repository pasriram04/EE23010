...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{m_{AB}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{m_{BC}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{m_{CA}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\text{rank}\myvec{1 & 1 & 1\\\vec{A} & \vec{B} & \vec{C}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{AB}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{BC}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{CA}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{Area of $\Delta$ABC}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{Angle}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$71.57\degree$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	{\gnumericPB{\centering}\gnumbox{Angle}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$36.87\degree$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
