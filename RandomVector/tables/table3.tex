...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{AD_1}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{BE_1}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{$\vec{n^{\top}_{CF_1}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-0.33\\4}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{Orthocenter}}
\\
\hhline{|-|-|-|}
%\end{longtable}
\end{tabular}
